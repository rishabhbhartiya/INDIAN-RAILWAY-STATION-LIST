...
for i in range(1,21):
    url = "https://etrain.info/station/Agastiyampalli-AGX/all"
    url = "https://etrain.info/list/STATIONS?page=1"
    url = "https://etrain.info/list/STATIONS?page=3"
    ...
    name = soup.find_all("div", class_="nocps fullw bx0s rnd5 rel")
    for n in name:
        Name.append(n.text)
    print("NAME",len(Name))
